...
public:
  ...
  void initialize()
  {
    ...
    initial_pose.position.x =-0.12020579725503922;
    initial_pose.position.y =  0.07182849198579788;
    initial_pose.position.z = 0.275874525308609;  

    initial_pose.orientation.x =4.279480708646588e-05;
    initial_pose.orientation.y = 7.232956704683602e-05;
    initial_pose.orientation.z = -2.501120798115153e-05;
